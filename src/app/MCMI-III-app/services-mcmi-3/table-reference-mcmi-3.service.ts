...
export class TableReferenceMcmi3Service {
  ...
  public X: Record<string, Record<string, number>> = {
    scaleX: this._createTableReference([
  ...
  public Male: Record<string, Record<string, number>> = {
    ...
    scaleS: this._createTableReference([
    ...
    scaleP: this._createTableReference([
    ...
    scaleN: this._createTableReference([
    ...
    scalePP: this._createTableReference([
  ...
  public Female: Record<string, Record<string, number>> = {
    scale1: this._createTableReference([
